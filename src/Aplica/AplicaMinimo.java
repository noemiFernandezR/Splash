 ...
 * @author ACER
 */
public class AplicaMinimo extends javax.swing.JFrame {

    /**
     * Creates new form AplicaMinimo
     */
    public AplicaMinimo() {
        initComponents();
        formulario();
    ...
    private void initComponents() {
        ...
        PanelPrincipal.setBackground(new java.awt.Color(255, 204, 255));

        PanelOperaciones.setBackground(new java.awt.Color(255, 204, 255));
        ...
        jLabel1.setText("Minimo de un número");

        PanelDatos.setBackground(new java.awt.Color(255, 204, 255));

        jLabel2.setText("Ingre un Numero");
        ...
        PanelDatosLayout.setHorizontalGroup(
            ...
            .addGroup(PanelDatosLayout.createSequentialGroup()
                ...
                .addGroup(PanelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtA)
                    .addComponent(txtB, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE))
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        if (txtA.getText().isEmpty()) {
            ...
            mini=Matematica.min(a,b);
            
            txtResultado.setText("\t Resultado");
            txtResultado.append("\n \t --------------------");
            txtResultado.append("\n Primer número : "+ String.valueOf(a));
            txtResultado.append("\n Segundo número : "+ String.valueOf(b));
            txtResultado.append("\n El número menor ingresado es: "+ String.valueOf(mini));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AplicaMinimo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AplicaMinimo().setVisible(true);
            }
        });
    }
